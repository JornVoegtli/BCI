...
class MyPyglet():
    def __init__(self):
        self.imageLoad = [pyglet.image.load('img/Vinay.jpg'), 
                        ...
                        pyglet.image.load('img/Aaron.jpg'),
                        pyglet.image.load('img/bit_trip.jpg'),
                        pyglet.image.load('img/blastoise.jpg'),
                        pyglet.image.load('img/carebear.jpg'),
                        pyglet.image.load('img/charizard.jpg'),
                        pyglet.image.load('img/Final_Flash.png'),
                        pyglet.image.load('img/hp.jpg'),
                        pyglet.image.load('img/Johnny_Bravo.png'),
                        pyglet.image.load('img/legoyoda.jpg'),
                        pyglet.image.load('img/pikachu.jpg'),
                        pyglet.image.load('img/powerpuffgirls.jpg'),
                        pyglet.image.load('img/Rasengan.jpg'),
                        pyglet.image.load('img/smb.jpg'),
                        pyglet.image.load('img/Super_Slime.png'),
                        pyglet.image.load('img/teletubby.png'),
                        pyglet.image.load('img/venusaur.jpg')]
    ...
    def drawTarget(self, rowStim, colStim):
        if (isDrawTarget):
            ...
            x = colNum * width / 6
            y = (5-rowNum) * (keyboardPositionTop/6) + targetSize[1]/2
    ...
    def updatePredictiveText(self):
        ...
        for i in range(len(self.matrices)): # Need to update for all matrices
            ...
            self.text[i][0][0] = corrected_text
