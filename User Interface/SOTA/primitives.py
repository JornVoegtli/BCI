...
def drawRect(x, y, width, height,color_r,color_g,color_b,color_a):
    P = Polygon([(x, y),(x,y+height),(x+width,y+height),(x+width,y)],color=(color_r,color_g,color_b,color_a))
    P.render() 
